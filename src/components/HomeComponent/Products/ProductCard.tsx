...
const {name, image, brand, category, rating, price,createdAt} = product || {}
    ...
    <>
      <div className=" overflow-hidden  rounded-lg shadow-lg bg-[#F9F7F7]">
        ...
        <div className=" ">
          ...
          <h1 className="text-lg font-mono text-[#4B5664]">BDT{price}</h1>
        ...
        <div className="flex items-center justify-between px-1  mb-2 bg-[#F9F7F7]">
          ...
          <Link to={`/login`} className="px-2 py-1 text-xs font-semibold text-white uppercase transition-colors duration-300 transform bg-[#3F72AF] rounded hover:bg-gray-200 hover:text-[#3F72AF] focus:bg-gray-400 focus:outline-none">
            Details
          </Link>
        </div>
      </div>
